...
const RoutecardhistoryReport = () => {
  ...
  useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await Permission(+RoleId, "RouteCardHistoryReport");
  ...
  const report = PowerBIReports.RouteCardHistoryReport;
  return (
...
export default RoutecardhistoryReport;
