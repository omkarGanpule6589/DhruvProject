...
const PowerReports = () => {
  ...
  useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await Permission(+RoleId, "Reports");
    ...
    <div className="iframe-container">
      <PowerBIEmbed
        embedConfig={{
          ...
          id: "581a2fbe-d347-4fc8-af5d-90c8f568f1cd",
          embedUrl:
            "https://app.powerbi.com/reportEmbed?reportId=581a2fbe-d347-4fc8-af5d-90c8f568f1cd&groupId=262a887c-9ee4-415e-84df-627d482c3906",
