...
const Wipsummary = () => {
  ...
  useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await Permission(+RoleId, "WipSummaryReport");
  ...
  const report = PowerBIReports.WipReport;
  return (
    ...
    <div className="iframe-container">
      <PowerBIEmbed
        embedConfig={{
         ...
         // https://app.powerbi.com/reportEmbed?reportId=c2e449bb-5898-482f-858c-c8e9904161dc&autoAuth=true&ctid=910d0953-f41a-4135-b36f-c6c74d58d5f0
          //https://app.powerbi.com/reportEmbed?reportId=fb1c636b-d1c6-49ee-8497-188cb0c8b029&autoAuth=true&ctid=083660d4-2afc-4466-bc51-06ffbf174806
          id: report.id,
