...
import itemsList from "./PowerBiReports.json";
...
export default function Powebi() {
  ...
  const storedIndex = sessionStorage.getItem("selectedIndexMatrixData");
  const [selectedIndex, setSelectedIndex] = useState(
    storedIndex ? storedIndex : null
  );
  // useEffect(() => {
  //   sessionStorage.setItem(
  //     "selectedIndexMatrixData",
  //     selectedIndex?.toString() || ""
  //   );
  // }, [selectedIndex]);
  useEffect(() => {
    sessionStorage.setItem("selectedIndexMatrixData", "");
  }, [selectedIndex]);
