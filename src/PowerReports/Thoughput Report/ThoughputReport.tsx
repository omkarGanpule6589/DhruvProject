...
const ThoughputReport = () => {
  ...
  useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await Permission(+RoleId, "ProductionReport");
  ...
  useEffect(() => {
   ...
   const report = PowerBIReports.ProductionReport;
  return (
  ...
  >
   ...
   id: report.id, // Use the id from PowerBIReports.ProductionReport
...
export default ThoughputReport;
