...
const MonthendReconclilationReport = () => {
  ...
  useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await Permission(+RoleId, "MonthendReconclilationReport");
  ...
  const report = PowerBIReports.MonthendReconclilationReport;
...
export default MonthendReconclilationReport
