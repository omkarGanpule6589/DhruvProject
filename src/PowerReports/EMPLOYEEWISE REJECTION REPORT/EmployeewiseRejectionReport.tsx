...
const EmployeewiseRejectionReport = () => {
  ...
  useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await Permission(+RoleId, "EmployeewiseRejectionReport");
  ...
  const report = PowerBIReports.EmployeeWiseRejectionReport;
  return (
...
export default EmployeewiseRejectionReport;
