...
const validationpop = Yup.object({
  RevName: Yup.string().trim().required("Name is required"),
});
const ConfirmDialogCopyobj = (props) => {
  ...
  const deletePipeline = async () => {
    ...
    const body = {
      [Bodyhead1]: id,
      [Bodyname]: values.RevName,
    };
    try {
      debugger
      const response = await CopyobjData(endPoint, body);
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} onReset={handleReset}>
        ...
        <MuiModules.UIDialogTitle>Copy</MuiModules.UIDialogTitle>
          ...
          >
            ...
            >
              <label style={{ fontSize: "14px" }}>
                Copy Name<span style={{ color: "red" }}>*</span>
              </label>
              <MuiModules.UITextField
                name="RevName"
                id="RevName"
...
export default ConfirmDialogCopyobj;
