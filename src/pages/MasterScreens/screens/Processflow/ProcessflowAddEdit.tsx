...
function ProcessflowAddEdit() {
        ...
        try {
          ...
          if (response.data.value.length > 0) {
            ...
            if (result?.ProcessflowSteps.length > 0) {
              ...
              console.log(JSON.stringify(proflow));
              proflow.map((item) => {
                let AlternateList = [];
                ...
                const newobj = {
                  ...
                  IsButtonIssueReq:item?.IsButtonIssueReq ?? false,
                };
                list.push(newobj);
              });
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      headerName: "Button Issue Required",
      width: 150,
    },
  ...
  const handlePostRequest = async () => {
    ...
    const body = {
      ...
      ProcessflowstepDetails: rows.map((row) => ({
        ...
        IsButtonIssueReq:row.IsButtonIssueReq,
    ...
    if (values.ActiveRevision === false) {
      ...
      try {
        ...
        if (response.data) {
          ...
          navigate("/masterdata/processflow");
        } else {
    ...
    if (!updatedRowData.ProcessflowStepId) {
      const newData1 = [
        ...rows,
        {
          ...
          IsButtonIssueReq:updatedRowData.IsButtonIssueReq,
      ...
      <form onSubmit={handleSubmit} onReset={handleReset}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <MuiIcons.ArrowCircleLeftOutlinedIcon
            onClick={() => navigate("/masterdata/processflow")}
...
export default ProcessflowAddEdit;
