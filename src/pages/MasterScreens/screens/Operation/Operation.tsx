...
import { getOperationList } from "./OperationAPI";
...
const Operation = () => {
  ...
  const baseColumns: GridColDef[] = [
    //{ field: "OperationId", headerName: "ID", width: 90 },
  ...
  const handleAddClick = () => {
    navigate("/masterdata/operationAddEdit");
  };
  ...
  const handleEditClick = (id) => {
    if (Read) {
      navigate(`/masterdata/operationAddEdit/${id}`);
    }
  };
  ...
  const deleteCnf = React.useCallback(
    (id: GridRowId, params) => () => {
      ...
      setDeleteData({ id, endPoint: `odata/Operation?key=${id}` });
      setDeleteDataName(params.row.OperationName);
    },
    []
  );
  ...
  return (
    ...
    >
      ...
      <MuiModules.UIBox sx={{ height: "400", width: "100%" }}>
        ...
        >
          <ExportImport Name={"Operation"} refresh={OnCallAPI} />
          {Add && (
