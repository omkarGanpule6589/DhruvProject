...
function InventoryLocation() {
  ...
  const baseColumns: GridColDef[] = [
    // { field: "InventoryLocationId", headerName: "ID", width: 100 },
    {
      ...
      headerName: "Inventory Location Name",
      width: 250,
    },
    {
      field: "Description",
  ...
  const handleAddClick = () => {
    navigate("/masterdata/inventorylocationAddEdit");
  };
  ...
  const handleEditClick = (id) => {
    if (Read) {
      navigate(`/masterdata/inventorylocationAddEdit/${id}`);
    }
  };
  ...
  return (
    ...
    >
      ...
      <MuiModules.UIBox sx={{ height: "400", width: "100%" }}>
        ...
        >
          <ExportImport Name={"InventoryLocation"} refresh={OnCallAPI} />
          {Add && (
