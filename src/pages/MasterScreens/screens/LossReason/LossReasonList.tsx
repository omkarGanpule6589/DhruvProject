...
import { getLossReasonList } from "./LossReasonApi";
...
function LossReasonList() {
  ...
  const [data, setData] = useState<LossReasonTypes[]>([]);
  ...
  const baseColumns: GridColDef[] = [
    //{ field: "LossReasonId", headerName: "ID", width: 100 },
    {
      field: "LossReasonName",
      headerName: "Loss Reason Name",
      width: 250,
    },
    {
      field: "Description",
  ...
  const handleAddClick = () => {
    navigate("/masterdata/lossreasonPageAddEdit");
  };

  const handleEditClick = (id) => {
    if (Read) {
      navigate(`/masterdata/lossreasonPageAddEdit/${id}`);
    }
  };
  ...
  return (
    ...
    >
      ...
      <MuiModules.UIBox sx={{ height: "400", width: "100%" }}>
        ...
        >
          <ExportImport Name={"LossReason"} refresh={OnCallAPI} />
          {Add && (
