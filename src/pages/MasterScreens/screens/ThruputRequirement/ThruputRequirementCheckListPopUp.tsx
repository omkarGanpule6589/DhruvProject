...
import { Checkbox } from "@mui/material";
import { getDataCollectionNames, getEmployeeGroupNames } from "./ThruputRequirementApi";

// export const validation = Yup.object({
//   CheckListName: Yup.string().required("Label TagName is required"),
//   Instruction: Yup.string().required("Instruction is required"),
// });

const ThruputRequirementCheckListPopUp = (props) => {
    ...
    useEffect(() => {
      if (isEdit && selectedRow) {
        setFieldValue("ThruputReqCheckListId", selectedRow?.ThruputReqCheckListId);
        setFieldValue("CheckListName", selectedRow?.CheckListName);
        setFieldValue("ThruputReqId", selectedRow?.ThruputReqId);
       ...
       // setFieldValue("UsageRequirement1", selectedRow?.UsageRequirement1);
        ...
        setFieldValue("ThruputReqCheckListId", null);
        setFieldValue("ThruputReqId", null);
  ...
  const handleEmployeeGroupData = (event, newValue) => {
    ...
    >
        ...
        >
            {!isEdit ? "Add Thruput Req Check List" : "Edit Thruput Req Check List"}
          </MuiModules.UIDialogTitle>
          <MuiModules.UIDialogContent style={{ height: "57vh" }}>
            ...
            >
              ...
              >
                <label style={{ fontSize: "14px" }}>Check List </label>
...
export default ThruputRequirementCheckListPopUp
