...
import ImportPopUpEmployee from "./ImportPopUpEmployee";
import UpateemployeeImport from "./UpateemployeeImport";

const ExportImportEmployee = (props) => {
  ...
  const handleCloseEditPopupUpdate = () => {
    setopenUpdate (false);
  };
  ...
  const ActionData = ["Download Template", "Upload Data","Update Data"];
  const handleAction = () => {
    switch (Action) {
  ...
  return (
    <>
      ...
      {openUpdate && (
        <UpateemployeeImport
          open={openUpdate}
          onClose={handleCloseEditPopupUpdate}
          refresh={refresh}
...
export default ExportImportEmployee;
