...
import { getComponentDefectReasonList } from "./ComponentDefectReasonApi";
...
interface ComponentDefectReason {
...
const ComponentDefectReason = () => {
  ...
  const [data, setData] = useState<ComponentDefectReason[]>([]);
  ...
  const baseColumns: GridColDef[] = [
    //{ field: "ComponentDefectReasonId", headerName: "ID", width: 100 },
    {
      field: "ComponentDefectReasonName",
      headerName: "Component Defect Reason Name",
      width: 250,
    },
    {
      field: "Description",
  ...
  const handleAddClick = () => {
    navigate("/masterdata/componentdefectreasonaddedit");
  };

  const handleEditClick = (id) => {
    if (Read) {
      navigate(`/masterdata/componentdefectreasonaddedit/${id}`);
    }
  };
  ...
  return (
    ...
    >
      ...
      <MuiModules.UIBox sx={{ height: "400", width: "100%" }}>
        ...
        >
          <ExportImport Name={"ComponentDefectReason"} refresh={OnCallAPI} />
          {Add && (
...
export default ComponentDefectReason;
