...
import { getDataCollectionNames, getEmployeeGroupNames } from "./UsageRequirementApi";
import { Checkbox } from "@mui/material";

 export const validation12 = Yup.object({
  CheckListName: Yup.string().required("Check List is required"),
  //Instruction: Yup.string().required("Instruction is required"),
});

const UsageReqCheckListPopUp = (props) => {
    ...
    useEffect(() => {
      if (isEdit && selectedRow) {
        setFieldValue("UsageReqCheckListId", selectedRow?.UsageReqCheckListId);
        setFieldValue("CheckListName", selectedRow?.CheckListName);
        setFieldValue("UsageReqId", selectedRow?.UsageReqId);
       ...
       // setFieldValue("UsageRequirement1", selectedRow?.UsageRequirement1);
        ...
        setFieldValue("UsageReqCheckListId", null);
        setFieldValue("UsageReqId", null);
  ...
  const handleEmployeeGroupData = (event, newValue) => {
    ...
    >
        ...
        >
            {!isEdit ? "Add Usage Req Check List" : "Edit Usage Req Check List"}
          </MuiModules.UIDialogTitle>
          <MuiModules.UIDialogContent style={{ height: "57vh" }}>
            ...
            >
              ...
              >
                <label style={{ fontSize: "14px" }}>Check List <span style={{ color: "red" }}>*</span></label>
              ...
              <p className="errorTextColor">{errors.CheckListName}</p>
            ) : null}
...
export default UsageReqCheckListPopUp
