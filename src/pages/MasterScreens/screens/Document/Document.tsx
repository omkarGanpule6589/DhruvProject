...
import { getDocumentList } from "./DocumentaPI";
import { ThemeContext } from "../../../../ContextMain";
import { Backdrop, CircularProgress, Hidden } from "@mui/material";
...
const Document = () => {
  ...
  const baseColumns: GridColDef[] = [
    // { field: "DocumentId", headerName: "ID", width: 100 },
    {
      field: "DocumentName",
  ...
  const handleAddClick = () => {
    navigate("/masterdata/documentaddedit");
  };

  const handleEditClick = (id) => {
    if (Read) {
      navigate(`/masterdata/documentaddedit/${id}`);
    }
  };
  ...
  return (
    ...
    >
      ...
      <MuiModules.UIBox sx={{ height: "400", width: "100%" }}>
        ...
        >
          <ExportImport Name={"Document"} refresh={OnCallAPI} />
          {Add && (
