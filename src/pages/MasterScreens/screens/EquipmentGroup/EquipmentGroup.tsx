...
import { getQtyEquipmentGroupList } from "./EquipmentGroupApi";
...
const EquipmentGroup = () => {
  ...
  const [qtyAdjustReason, setQtyAdjustReason] = useState<EquipmentGroup[]>([]);
  ...
  const baseColumns: GridColDef[] = [
    // { field: "QtyAdjustReasonId", headerName: "ID", width: 90 },
    {
      ...
      headerName: "Equipment Group Name",
      width: 250,
    },
    {
      field: "Description",
  ...
  const handleAddClick = () => {
    navigate("/masterdata/equipmentgroupaddedit");
  };
  ...
  const handleEditClick = (id) => {
    if (Read) {
      navigate(`/masterdata/equipmentgroupaddedit/${id}`);
    }
  };
  ...
  return (
    ...
    >
      ...
      <MuiModules.UIBox sx={{ height: "400", width: "100%" }}>
        ...
        >
          <ExportImport Name={"EquipmentGroup"} refresh={OnCallAPI} />
          {Add && (
