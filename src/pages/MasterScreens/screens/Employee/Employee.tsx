...
import ExportImportEmployee from "../UploadEmploye/ExportImportEmployee";
...
function Employee() {
  ...
  const baseColumns: GridColDef[] = [
    ...
    {
      field: "FullName",
      headerName: "Employee Full Name Name",
      width: 250,
    },
    {
      field: "EmployeeName",
  ...
  const handleAddClick = () => {
    navigate("/masterdata/employeeAddEdit");
  };

  const handleEditClick = (id) => {
    if (Read) {
      navigate(`/masterdata/employeeAddEdit/${id}`);
    }
  };
    ...
    >
      ...
      <MuiModules.UIBox sx={{ height: "400", width: "100%" }}>
        ...
        >
          ...
          <ExportImportEmployee Name={"Employee"} refresh={OnCallAPI} />
          {/* <ExportImport Name={"Employee"} refresh={OnCallAPI} /> */}
          {Add && (
