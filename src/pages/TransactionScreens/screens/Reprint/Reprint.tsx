...
import { Preprint } from "./Reprintapi";
 ...
 // const routeCardRef = useRef(null);
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await Permission(+RoleId, "RePrintService")
  ...
  const [paginationModel, setPaginationModel] = useState({
    ...
    // }));
    const RouteCardIds = Data.map(row => row.RouteCardId);
 ...
 <div style={{ marginTop: "auto" }} onClick={handleopen}>
  ...
  {Inrework&& (
            ...
            >
              ...
              <h2 style={{ float: "right" }}> Re Print</h2>
            </MuiModules.UIGrid>
          </MuiModules.UIGrid>
